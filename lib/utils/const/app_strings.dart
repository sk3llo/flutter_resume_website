abstract class AppStrings {
  ...
  static const aboutPageHeaderFirstSubtitleFlipped =
      "I'm Anton, just a big kid 🧒 who loves to explore the world 🌎 and dive"
      " deep 🐬 into things around him.";

  static const aboutPageBodyTitle = "I'm currently working as a Senior Flutter "
      "Developer for Ukrainian Enterprise company and helping to architect, "
      "develop and maintain various projects. ";
  static const aboutPageBodySubtitle =
      "Previously, I worked with numerous startups and enterprises "
      "around the world as a freelancer and full-tile employee, "
      "including Caterpillar (world's leading manufacturer of mining and construction"
      " equipment), Huck Adventures (a Colorado-based recreational startup) "
      "and Bunq (Mobile banking that Makes Life Easy). By utilizing Flutter I've also"
      " created my personal app that received ≈ 20.000 downloads in about a year. "
      "Outside work I love to spend time with my family, play guitar or work "
      "on pet projects. Life is beautiful.";
  ...
  static const aboutPageBottomSubtitle = "I am always on the lookout for "
